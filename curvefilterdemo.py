...
class Sim:
    ...
    dia_width = 300 #250     # for the 12 little diagrams on the right side
...
def create_stuff2():
    ...
    Sim.gui["filter_apply"] = vp.button(pos=Sim.scene.caption_anchor, bind=widget_func_filter_apply, text="apply")
